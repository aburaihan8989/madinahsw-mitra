...
class Kelas1RiwayatTasksDataTable extends DataTable
{
    ...
    public function dataTable($query) {
        return datatables()
            ...
            ->editColumn('kelas1_task_end_date', function($model){
                $formatDate = date('d-m-Y',strtotime($model->kelas1_task_end_date));
                return $formatDate;
            })
    ...
    protected function getColumns() {
        return [
            ...
            Column::make('kelas1_task_end_date')
