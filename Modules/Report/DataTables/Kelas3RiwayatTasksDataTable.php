...
class Kelas3RiwayatTasksDataTable extends DataTable
{
    ...
    public function dataTable($query) {
        return datatables()
            ...
            ->editColumn('kelas3_task_end_date', function($model){
                $formatDate = date('d-m-Y',strtotime($model->kelas3_task_end_date));
                return $formatDate;
            })
            ...
            ->addColumn('action', function ($data) {
                return view('report::kelas3-task.partials.actions-riwayat', compact('data'));
            });
    }
    ...
    protected function getColumns() {
        return [
            ...
            Column::make('kelas3_task_end_date')
