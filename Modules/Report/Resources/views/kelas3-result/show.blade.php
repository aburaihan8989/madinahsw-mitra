...
@if ($kelas3_result->kelas3_result_waktu == 1)
    @section('title', 'View Nilai Pagi Siswa Kelas Mengaji Al Quran')
@elseif ($kelas3_result->kelas3_result_waktu == 2)
    @section('title', 'View Nilai Siang Siswa Kelas Mengaji Al Quran')
@else
    @section('title', 'View Nilai Sore Siswa Kelas Mengaji Al Quran')
@endif
...
@section('breadcrumb')
    <ol class="breadcrumb border-0 m-0">
        ...
        @if ($kelas3_result->kelas3_result_waktu == 1)
            <li class="breadcrumb-item active">View Nilai Pagi Siswa Kelas Mengaji Al Quran</li>
        @elseif ($kelas3_result->kelas3_result_waktu == 2)
            <li class="breadcrumb-item active">View Nilai Siang Siswa Kelas Mengaji Al Quran</li>
        @else
            <li class="breadcrumb-item active">View Nilai Sore Siswa Kelas Mengaji Al Quran</li>
        @endif
    </ol>
@endsection
                        ...
                        <div class="form-row">
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control" name="kelas3_result_date" required value="{{ $kelas3_result->kelas3_result_date }}" readonly disabled>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-lg-4">
                                <div class="from-group">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="kelas3_result_student_id" id="kelas3_result_student_id" required readonly disabled>
                            ...
                            <div class="col-lg-4">
                                <div class="from-group">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="kelas3_result_teacher_id" id="kelas3_result_teacher_id" required readonly disabled>
                            ...
                            <div class="col-lg-4">
                                <div class="from-group">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="kelas3_result_studi_id" id="kelas3_result_studi_id" required readonly disabled>
                        ...
                        <div class="form-row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="kelas3_result_book1" id="kelas3_result_book1" required readonly disabled>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="kelas3_result_book2" id="kelas3_result_book2" required readonly disabled>
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="kelas3_result_book3" value="{{ $kelas3_result->kelas3_result_book3 }}" readonly disabled>
                                </div>
                            </div>
                            @if ($kelas3_result->kelas3_result_waktu == 1)
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="kelas3_result_value1" value="{{ $kelas3_result->kelas3_result_value1 }}" readonly disabled>
                                    </div>
                                </div>
                            @elseif ($kelas3_result->kelas3_result_waktu == 2)
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="kelas3_result_value2" value="{{ $kelas3_result->kelas3_result_value2 }}" readonly disabled>
                                    </div>
                                </div>
                            @else
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="kelas3_result_value3" value="{{ $kelas3_result->kelas3_result_value3 }}" readonly disabled>
                                    </div>
                                </div>
                            @endif
                        </div>
                        ...
                        <div class="form-row">
                            <div class="col-lg-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="kelas3_result_note" id="kelas3_result_note" rows="3 " class="form-control" readonly disabled>{{ $kelas3_result->kelas3_result_note }}</textarea>
                                </div>
                            </div>
                        </div>
