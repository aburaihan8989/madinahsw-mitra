...
@section('title', 'Input Nilai Sore Siswa Kelas Mengaji Al Quran')

@section('breadcrumb')
    <ol class="breadcrumb border-0 m-0">
        <li class="breadcrumb-item"><a href="{{ route('home') }}">Home</a></li>
        <li class="breadcrumb-item"><a href="{{ route('kelas3-task.index') }}">Kelas Mengaji Al Quran</a></li>
        <li class="breadcrumb-item active">Input Nilai Sore Siswa Kelas Mengaji Al Quran</li>
    </ol>
@endsection

@section('content')
    <div class="container-fluid">
        <form id="kelas3-result-form" action="{{ route('kelas3-result.sore_store', $kelas3_result) }}" method="POST">
            @csrf
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <label for="kelas3_result_value3" class="text-danger">Nilai Sore (Kemarin) <span class="text-danger"></span></label>
                                        <input type="text" class="form-control" value="{{ $result_kemarin->kelas3_result_value3 ?? '' }}" readonly disabled>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="kelas3_result_value3">
                                    </div>
                                </div>
                            </div>
                            ...
                            <input type="hidden" value="3" name="kelas3_result_waktu">
