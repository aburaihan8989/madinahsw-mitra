...
@section('title', 'Input Nilai Siang Siswa Kelas Mengaji Anak SD')

@section('breadcrumb')
    <ol class="breadcrumb border-0 m-0">
        <li class="breadcrumb-item"><a href="{{ route('home') }}">Home</a></li>
        <li class="breadcrumb-item"><a href="{{ route('kelas2-task.index') }}">Kelas Mengaji Anak SD</a></li>
        <li class="breadcrumb-item active">Input Nilai Siang Siswa Kelas Mengaji Anak SD</li>
    </ol>
@endsection

@section('content')
    <div class="container-fluid">
        <form id="kelas2-result-form" action="{{ route('kelas2-result.siang_store', $kelas2_result) }}" method="POST">
            @csrf
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <label for="kelas2_result_value2" class="text-danger">Nilai Siang (Kemarin) <span class="text-danger"></span></label>
                                        <input type="text" class="form-control" value="{{ $result_kemarin->kelas2_result_value2 ?? '' }}" readonly disabled>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="kelas2_result_value2">
                                    </div>
                                </div>
                            </div>
                            ...
                            <input type="hidden" value="2" name="kelas2_result_waktu">
