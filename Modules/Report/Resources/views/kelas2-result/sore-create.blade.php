...
@section('title', 'Input Nilai Sore Siswa Kelas Mengaji Anak SD')

@section('breadcrumb')
    <ol class="breadcrumb border-0 m-0">
        <li class="breadcrumb-item"><a href="{{ route('home') }}">Home</a></li>
        <li class="breadcrumb-item"><a href="{{ route('kelas2-task.index') }}">Kelas Mengaji Anak SD</a></li>
        <li class="breadcrumb-item active">Input Nilai Sore Siswa Kelas Mengaji Anak SD</li>
    </ol>
@endsection

@section('content')
    <div class="container-fluid">
        <form id="kelas2-result-form" action="{{ route('kelas2-result.sore_store', $kelas2_result) }}" method="POST">
            @csrf
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="form-group">
                        ...
                        <button class="btn btn-primary">Simpan Nilai Sore <i class="bi bi-floppy ml-1"></i></button>
                    </div>
                </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="form-row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="kelas2_result_book1" class="text-danger">Nama IQRA (Kemarin) <span class="text-danger"></span></label>
                                        <input type="text" class="form-control" value="{{ $result_kemarin->kelas2_result_book1 ?? '' }}" readonly disabled>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <label for="kelas2_result_book2" class="text-danger">Halaman / Baris (Kemarin) <span class="text-danger"></span></label>
                                        <input type="text" class="form-control" value="{{ $result_kemarin->kelas2_result_book2 ?? '' }}" readonly disabled>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <label for="kelas2_result_value3" class="text-danger">Nilai Sore (Kemarin) <span class="text-danger"></span></label>
                                        <input type="text" class="form-control" value="{{ $result_kemarin->kelas2_result_value3 ?? '' }}" readonly disabled>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="kelas2_result_value3">
                                    </div>
                                </div>
                            </div>
                            ...
                            <input type="hidden" value="3" name="kelas2_result_waktu">
