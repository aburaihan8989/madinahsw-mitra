...
@if ($kelas2_result->kelas2_result_waktu == 1)
    @section('title', 'Edit Nilai Pagi Siswa Kelas Mengaji Anak SD')
@elseif ($kelas2_result->kelas2_result_waktu == 2)
    @section('title', 'Edit Nilai Siang Siswa Kelas Mengaji Anak SD')
@else
    @section('title', 'Edit Nilai Sore Siswa Kelas Mengaji Anak SD')
@endif
...
@section('breadcrumb')
    <ol class="breadcrumb border-0 m-0">
        ...
        @if ($kelas2_result->kelas2_result_waktu == 1)
            <li class="breadcrumb-item active">Edit Nilai Pagi Siswa Kelas Mengaji Anak SD</li>
        @elseif ($kelas2_result->kelas2_result_waktu == 2)
            <li class="breadcrumb-item active">Edit Nilai Siang Siswa Kelas Mengaji Anak SD</li>
        @else
            <li class="breadcrumb-item active">Edit Nilai Sore Siswa Kelas Mengaji Anak SD</li>
        @endif
    </ol>
@endsection
...
@section('content')
    <div class="container-fluid">
        <form id="kelas2-result-form" action="{{ route('kelas2-result.update', $kelas2_result) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('patch')
            <div class="row">
                <div class="col-lg-12">
                            ...
                            <div class="form-row">
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control" name="kelas2_result_date" required value="{{ $kelas2_result->kelas2_result_date }}" readonly>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="kelas2_result_book2" value="{{ $kelas2_result->kelas2_result_book2 }}">
                                    </div>
                                </div>
                                @if ($kelas2_result->kelas2_result_waktu == 1)
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="kelas2_result_value1" value="{{ $kelas2_result->kelas2_result_value1 }}">
                                        </div>
                                    </div>
                                @elseif ($kelas2_result->kelas2_result_waktu == 2)
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="kelas2_result_value2" value="{{ $kelas2_result->kelas2_result_value2 }}">
                                        </div>
                                    </div>
                                @else
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            <label for="kelas2_result_value3">Nilai Sore <span class="text-danger"></span></label>
                                            <input type="text" class="form-control" name="kelas2_result_value3" value="{{ $kelas2_result->kelas2_result_value3 }}">
                                        </div>
                                    </div>
                                @endif
                            </div>
                            ...
                            <div class="form-row">
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <textarea name="kelas2_result_note" id="kelas2_result_note" rows="3 " class="form-control">{{ $kelas2_result->kelas2_result_note }}</textarea>
                                    </div>
                                </div>
                            </div>

                            <input type="hidden" value="{{ $kelas2_result->kelas2_result_task_id }}" name="kelas2_result_task_id">
                            <input type="hidden" value="{{ $kelas2_result->kelas2_result_class_id }}" name="kelas2_result_class_id">
                            <input type="hidden" value="{{ $kelas2_result->kelas2_result_waktu }}" name="kelas2_result_waktu">
