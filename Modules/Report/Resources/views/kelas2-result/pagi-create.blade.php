                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <label for="kelas2_result_value1" class="text-danger">Nilai Pagi (Kemarin) <span class="text-danger"></span></label>
                                        <input type="text" class="form-control" value="{{ $result_kemarin->kelas2_result_value1 ?? '' }}" readonly disabled>
                                    </div>
                                </div>
                            </div>
