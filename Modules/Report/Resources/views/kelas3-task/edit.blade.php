...
@section('title', 'Edit Daftar Siswa Kelas Mengaji Al Quran')

@section('breadcrumb')
    <ol class="breadcrumb border-0 m-0">
        <li class="breadcrumb-item"><a href="{{ route('home') }}">Home</a></li>
        <li class="breadcrumb-item"><a href="{{ route('kelas3-task.index') }}">Kelas Mengaji Al Quran</a></li>
        <li class="breadcrumb-item active">Edit Daftar Siswa Kelas Mengaji Al Quran</li>
    </ol>
@endsection

@section('content')
    <div class="container-fluid">
        <form id="kelas3-task-form" action="{{ route('kelas3-task.update', $kelas3_task) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('patch')
            <div class="row">
                <div class="col-lg-12">
                            ...
                            <div class="form-row">
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="kelas3_task_code" required value="{{ $kelas3_task->kelas3_task_code }}" readonly>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <label for="kelas3_task_date">Tanggal Daftar <span class="text-danger">*</span></label>
                                        <input type="date" class="form-control" name="kelas3_task_date" required value="{{ $kelas3_task->kelas3_task_date }}">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-row">
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <textarea name="kelas3_task_note" id="kelas3_task_note" rows="3 " class="form-control">{{ $kelas3_task->kelas3_task_note }}</textarea>
                                    </div>
                                </div>
                            </div>
