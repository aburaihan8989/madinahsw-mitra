                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <label for="report1_value1" class="text-danger">Nilai Pagi (Kemarin) <span class="text-danger"></span></label>
                                        <input type="text" class="form-control" value="{{ $result_kemarin->report1_value1 ?? '' }}" readonly disabled>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <label for="report1_book2">Halaman / Baris <span class="text-danger"></span></label>
