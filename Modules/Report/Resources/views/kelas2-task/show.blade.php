...
@section('title', 'View Daftar Siswa Kelas Mengaji Anak SD')

@section('breadcrumb')
    <ol class="breadcrumb border-0 m-0">
        <li class="breadcrumb-item"><a href="{{ route('home') }}">Home</a></li>
        <li class="breadcrumb-item"><a href="{{ route('kelas2-task.index') }}">Kelas Mengaji Anak SD</a></li>
        <li class="breadcrumb-item active">View Daftar Siswa Kelas Mengaji Anak SD</li>
    </ol>
@endsection
                        ...
                        <div class="form-row">
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="kelas2_task_code" required value="{{ $kelas2_task->kelas2_task_code }}" readonly disabled>
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="form-group">
                                    <label for="kelas2_task_date">Tanggal Daftar <span class="text-danger">*</span></label>
                                    <input type="date" class="form-control" name="kelas2_task_date" required value="{{ $kelas2_task->kelas2_task_date }}" readonly disabled>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-lg-4">
                                <div class="from-group">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="kelas2_task_student_id" id="kelas2_task_student_id" required readonly disabled>
                            ...
                            <div class="col-lg-4">
                                <div class="from-group">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="kelas2_task_teacher_id" id="kelas2_task_teacher_id" required readonly disabled>
                            ...
                            <div class="col-lg-4">
                                <div class="from-group">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="kelas2_task_studi_id" id="kelas2_task_studi_id" required readonly disabled>
                        ...
                        <div class="form-row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="kelas2_task_active" id="kelas2_task_active" required readonly disabled>
                        ...
                        <div class="form-row">
                            <div class="col-lg-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="kelas2_task_note" id="kelas2_task_note" rows="3 " class="form-control" readonly disabled>{{ $kelas2_task->kelas2_task_note }}</textarea>
                                </div>
                            </div>
                        </div>
