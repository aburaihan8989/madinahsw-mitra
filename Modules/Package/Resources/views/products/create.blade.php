            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="form-group">
                        ...
                        <button class="btn btn-primary">Tambah Layanan <i class="bi bi-floppy ml-1"></i></button>
                    </div>
                </div>
                            ...
                            <div class="form-row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input id="product_cost" type="text" class="form-control" name="product_cost" value="{{ old('product_cost') }}" required>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="product_category" id="product_category" required>
                                            ...
                                            <option value="3">Siskopatuh</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-4">
