                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-lg-2">
                                    <div class="form-check">
                                      <input class="form-check-input" type="checkbox" id="visa" name="visa" value="1" {{ $manifest->visa == '1' ? 'checked' : '' }}>
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-lg-2">
                                    <div class="form-check">
                                      <input class="form-check-input" type="checkbox" id="siskopatuh" name="siskopatuh" value="1" {{ $manifest->siskopatuh == '1' ? 'checked' : '' }}>
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-lg-2">
                                    <div class="form-check">
                                      <input class="form-check-input" type="checkbox" id="hotel" name="hotel" value="1" {{ $manifest->hotel == '1' ? 'checked' : '' }}>
