...
class RewardsController extends Controller
{
    ...
    public function getCustomerNetwork() {
        ...
        $getdata = Http::get('http://marhaban-travel.test/api/customer-network/' . auth()->user()->agent_id);
    ...
    public function getAgentNetwork() {
        // abort_if(Gate::denies('access_customers'), 403);
        $getdata = Http::get('http://marhaban-travel.test/api/agent-network/' . auth()->user()->agent_id);
