                            ...
                            <div class="form-row">
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <textarea name="customer_note" id="customer_note" rows="3 " class="form-control"></textarea>
                                    </div>
                                </div>
                            </div>
                            <br>
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="customer_paspor_imigrasi">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-row">
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control" name="customer_paspor_tgl_aktif" value="{{ \Carbon\Carbon::now()->format('Y-m-d') }}">
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="form-group">
